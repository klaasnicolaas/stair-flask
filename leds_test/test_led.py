    ...
    try:
        while True:
            if CLEAR:
                ...
                colorWipe(strip, Color(255, 0, 0), direction=1)  # Red wipe
                colorWipe(strip, Color(0, 255, 0), direction=0)  # Green wipe
                colorWipe(strip, Color(0, 0, 255), direction=1)  # Blue wipe
                colorWipe(strip, Color(255, 255, 0), direction=0)  # Yellow wipe
